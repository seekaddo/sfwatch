...
static void do_files(const char *path, string *str);

static void do_dir(const char *path, string *fp);

static void handle_events(int fd, int *wd, size_t argc, string *argv);
...
static void do_files(const char *path, string *fnames) {
...
static void do_dir(const char *path, string *fps) {
